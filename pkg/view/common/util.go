...
// NOTE: View definition persistence (Save/Get/Delete) has been moved to
// pkg/controlplane/storeservice.go. The control plane now owns the store.
// Agents receive view definitions from the control plane, they don't access the store directly.
